            ...
            <ul className="flex gap-4">
              <li>
                <a
                  ...
                  className={
                    "h-7 w-7 mr-1 rounded-full flex justify-center items-center text-slate-300 border border-slate-300 hover:border-primary hover:bg-[#333333] hover:text-white "
                  }
                  target={"_blank"}
                  rel="noreferrer"
                >
