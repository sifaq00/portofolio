    ...
    <section>
          <div className="container m-auto px-4 pt-12 pb-12 sm:pt-28 flex flex-col sm:flex-row gap-6 text-center sm:text-left" data-aos="fade-right">
            ...
            <div className="relative ">
              <div className="after:bg-[url('./assest/large-long.png')] after:bg-contain after:block after:bg-no-repeat after:w-[420px] after:h-[320px] after:absolute after:top-0 after:-left-20 sm:after:-left-40 before:bg-[url('./assets/small.png')] before:bg-contain before:block before:bg-no-repeat before:w-[220px] before:h-[220px] before:absolute before:bottom-0 before:-right-10">
